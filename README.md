...
## Robot binary bootstrap

Windows robot users do not need admin rights for the LibreOffice/Tesseract bootstrap paths. Defaults land under `%LOCALAPPDATA%\oomtm`; override these when using an internal mirror or a fixed robot tools folder:
